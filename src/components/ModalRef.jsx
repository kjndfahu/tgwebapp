    ...
    return (
        <div className="flex flex-col bg-black h-[100vh]">
            ...
            <div className="flex flex-col px-5 mt-5 text-white font-sfpromedium text-[14px]">
                <p >Referir via</p>
                <div className="flex gap-3 flex-row items-center py-2 px-3 bg-[#212121] rounded-[15px] mt-2">
                    <h2>Enlace</h2>
                    <div className="text-[#2890FF] gap-1 flex flex-row items-center text-[15px] px-4 py-1 rounded-[7px] active:bg-[#15406E]">
                ...
                <div className="flex flex-row items-center justify-between py-2 px-3 bg-[#212121] rounded-[15px] mt-2 mb-10">
